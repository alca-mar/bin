#!/bin/bash
# ~/bin/NuevaPropiedad.sh
# CRE: 21/02/2019

# Creada a partir de:
# GrupoEuroga - NuevaPropiedad
# CRE:	03/05/2017
# MOD:	17/05/2017
...
## RUTAS
PATH_propiedades="$HOME/Documentos/Propiedades"
...
TXT_listapropiedades="\nListado de propiedades 2019 del tipo"
...
find * -iname "[$tipo]1[9][0-9][0-9].-*" -type d
printf "\nFin del listado\n"
...
read _electricidad
echo "Acceso a red colacal [si/no]"
read _cloaca
...
read comision_sn
echo "Comisión a aplicar, IVA no incluido. [Total/%]"
read com
...
@Alca-Mar
Av. Matiauda, Barrio San Pedro
Encarnación - Itapúa - Paraguay

Móvil: (0972) 573079 [whatsapp]
Correo: AlcaMar.Correo@gmail.com
